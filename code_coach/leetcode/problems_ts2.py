"""TypeScript solutions, patterns 5–13. Continues `problems_ts`."""

from __future__ import annotations

from code_coach.leetcode.problems import Pattern
from code_coach.leetcode.ts_common import GRAPH_NODE, LIST_NODE, TREE_NODE, _p
    ...
    problems=(
        ...
        _p(
            ...
            function searchRange(nums: number[], target: number): number[] {
              const edge = (first: boolean): number => {
                let low = 0;
...
_GRAPH = Pattern(
    ...
    problems=(
        ...
        _p(
            ...
            function cloneGraph(
              node: GraphNode | null,
              made: Map<GraphNode, GraphNode> = new Map(),
            ): GraphNode | null {
              if (node === null) return null;
              const existing = made.get(node);
        ...
        _p(
            ...
            function pacificAtlantic(heights: number[][]): number[][] {
              ...
              const climb = (r: number, c: number, seen: Set<string>): void => {
                seen.add(`${r},${c}`);
                for (const [dr, dc] of [[1, 0], [-1, 0], [0, 1], [0, -1]]) {
                  const nr = r + dr;
                  const nc = c + dc;
    ...
    problems=(
        ...
        _p(
            ...
            function combinationSum(candidates: number[], target: number): number[][] {
              ...
              function backtrack(start: number, left: number): void {
                if (left === 0) {
                  out.push([...current]);
                  return;
                }
        ...
        _p(
            ...
            function exist(board: string[][], word: string): boolean {
              ...
              function search(r: number, c: number, i: number): boolean {
        ...
        _p(
            ...
            function letterCombinations(digits: string): string[] {
              ...
              const out: string[] = [];
              const walk = (index: number, built: string): void => {
        ...
        _p(
            ...
            """
            function partition(text: string): string[][] {
              const out: string[][] = [];
              const built: string[] = [];
              const walk = (start: number): void => {
    ...
    problems=(
        ...
        _p(
            ...
            function kClosest(points: number[][], k: number): number[][] {
              const distance = (p: number[]): number => p[0] * p[0] + p[1] * p[1];
              return [...points]
    ...
    problems=(
        _p(
            ...
            function canFinish(
              ...
              const nextCourses: number[][] = Array.from(
                { length: numCourses },
                () => [],
              );
              const waitingOn = new Array<number>(numCourses).fill(0);
        ...
        _p(
            ...
            function checkIfPrerequisite(
              ...
              const needs: Set<number>[] = Array.from(
                { length: numCourses },
                () => new Set<number>()
              );
              const queue: number[] = [];
            ...
            function alienOrder(words: string[]): string {
              ...
              for (const word of words) {
                for (const ch of word) {
                  if (!graph.has(ch)) graph.set(ch, new Set<string>());
    ...
    problems=(
        ...
        _p(
            ...
            function lengthOfLIS(nums: number[]): number {
              ...
              const best = new Array<number>(nums.length).fill(1);
              let longest = 1;
        ...
        _p(
            ...
            'O(m * n) time, O(m * n) space',
            """
            function longestCommonSubsequence(first: string, second: string): number {
              const grid: number[][] = Array.from({ length: first.length + 1 }, () =>
        ...
        _p(
            ...
            """
            function wordBreak(text: string, words: string[]): boolean {
