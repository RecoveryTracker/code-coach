...
_WRAPS = (
    ...
    ("quad", "n * 4", "func(n) + 2", 6),
    ("cubed", "n * n * n", "func(n) + 20", 3),
    ("fivex", "n * 5", "func(n) * 2", 4),
    ("third", "n // 3", "func(n) + 50", 11),
    ("flip", "-n", "func(n) - 2", 9),
    ("add_two", "n + 2", "func(n) * 4", 7),
    ("hundredth", "n // 100", "func(n) + 3", 950),
    ("sixx", "n * 6", "func(n) - 5", 5),
)
...
_CALLABLES = (
    ...
    ("Power", "exp", 2, "n ** exp", 5),
    ("Raiser", "amount", 9, "n + amount", 15),
    ("Stretcher", "factor", 4, "n * factor", 8),
    ("Lowerer", "by", 200, "n - by", 350),
    ("Copier", "times", 6, "n * times", 7),
    ("Limiter", "top", 80, "n if n < top else top", 120),
    ("Raiser2", "floor", 20, "n if n > floor else floor", 5),
    ("Divider", "parts", 5, "n // parts", 60),
    ("Wrapper_", "by", 9, "n % by", 62),
)
...
_SETTERS = (
    ...
    ("Person", "gus", "  ada lovelace  "),
    ("Person", "hal", "  alan kay "),
    ("User", "ivy", " grace hopper  "),
    ("Author", "jan", "  ursula le guin "),
    ("Player", "kit", " john conway  "),
    ("Guest", "lee", "  mary somerville "),
    ("Member", "mia", " emmy noether  "),
    ("Client", "noa", "  claude shannon "),
)
...
_ORDERINGS = (
    ...
    ("Token", "worth", (4, 11)),
    ("Runner", "score", (37, 82)),
    ("Volume", "pages", (224, 261)),
    ("Town", "people", (17, 709)),
    ("Track_", "seconds", (207, 386)),
    ("Ore", "melting", (232, 327)),
    ("Berth", "floor", (2, 5)),
    ("Blade", "weight", (2, 9)),
)
