...
def expected_output(shape: str, args: dict) -> str:
    ...
    if emit_nodes.handles(shape):
        return emit_nodes.expected_output(shape, args, _value)
    ...
    if emit_algo2.handles(shape):
        return emit_algo2.expected_output(shape, args, _value)
    if emit_algo.handles(shape):
        return emit_algo.expected_output(shape, args, _value)
    if emit_ts6.handles(shape):
        return emit_ts6.expected_output(shape, args, _value)
    if emit_ts5.handles(shape):
        return emit_ts5.expected_output(shape, args, _value)
    if emit_ts4.handles(shape):
        return emit_ts4.expected_output(shape, args, _value)
    if emit_ts3.handles(shape):
        return emit_ts3.expected_output(shape, args, _value)
