...
_MERGES = (
    ...
    ((("colour", "blue"), ("size", "small")), (("size", "huge"),), "colour"),
...
_PADS = (
    ...
    ("8", 3, "0", "gus", 6, ".", "  wide  ", "d-e-f", "-", "+"),
    ("4", 4, "0", "hal", 5, "_", "  room  ", "p_q_r", "_", "-"),
    ("2", 3, "0", "ivy", 7, "*", " near ", "4.5.6", ".", "/"),
    ("55", 5, "0", "jan", 4, "-", "  open  ", "d e f", " ", ","),
    ("7", 2, "0", "kit", 6, "+", " cut ", "s:t:u", ":", ";"),
    ("1", 4, " ", "lee", 5, "=", "  fill  ", "two-six", "-", "="),
    ("9", 3, "0", "mia", 8, ".", " over ", "d,e,f", ",", "|"),
    ("3", 5, "0", "noa", 6, "~", "  gaps  ", "p/q/r", "/", "-"),
)
...
_ERRORS = (
    ...
    ("Unsupported", "cannot handle that"),
    ("Duplicated", "seen that already"),
    ("Corrupted", "the bytes are wrong"),
    ("Forbidden", "you may not"),
    ("Detached", "nothing is attached"),
    ("TooSmall", "under the limit"),
    ("OutOfOrder", "that came too soon"),
    ("Stale", "this is out of date"),
)
