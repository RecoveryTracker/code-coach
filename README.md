...
| **Forms** | Write a function; it is called with inputs you have not seen. 102 across 15 families, including The Odin Project's computer science section, Fix the bug, and Change it — working code and a change request, in Python, JavaScript and Dart |
| **Trace** | Stop a program part way and say what a variable holds, then step through and watch. 9 moments |
| **Errors** | A program that crashed and the message it printed. Which line, and what is it telling you? 17 of them, in Python, JavaScript and Dart |
| **Bug Hunt** | A bug report and the program it is about. Reproduce it, find the line, say what is wrong, then fix it — in that order, because the order is the skill. 26 hunts, in Python, JavaScript and Dart |
...
| **Magnets** | The lines of a working program, shuffled. Put them back under the stage each belongs to. JavaScript and Dart |
| **Predict** | Read the code, say what it prints. 68 puzzles: Python, 29 JavaScript and 12 Dart |
